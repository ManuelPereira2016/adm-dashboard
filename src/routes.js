...
import { Page404, Page500, PageLoading } from "./views/Pages";
...
const AdminDashHomeContainer = Loadable({
  loader: () =>
    import("./containers/AdminDashHomeContainer/AdminDashHomeContainer"),
  loading: Loading
});
...
const routes = [
  ...
  { path: "/login", name: "Login", component: LoginContainer },
  {
    ...
    name: "Questionario de validacion",
...
const adminRoutes = [
  ...
  { path: "/admin/lists", name: "Listas", component: AdminListsContainer },
  { path: "/admin/users", name: "Usuarios", component: AdminUsersContainer },
  {
    path: "/admin/settings",
    name: "Configuracion del questionario",
    component: AdminSettingsContainer
  },
  {
    path: "/admin/dashboard",
    name: "Dashboard",
    component: AdminDashHomeContainer
  },
  { path: "/admin", name: "Dashboard", component: AdminDashHomeContainer }
];
